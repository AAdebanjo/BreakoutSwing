  ...
  public void drawActualPicture( Graphics2D g )
  {
    ...
    synchronized( Model.class )   // Make thread safe
    {
     ...
     if(powerup.isVisible())
      ...
      String fmt = "Breakout! Destroy as many bricks as possible! Your score = %6d Lives = %1d %5.1fFPS";
      String text = String.format(fmt, score, lives,
